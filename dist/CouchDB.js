...
var CouchDB = /** @class */ (function () {
    function CouchDB(connectionUrl) {
        this._instance = nano_1.default(connectionUrl);
    }
    CouchDB.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var createdDatabases;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._instance.db.list()];
                    case 1:
                        createdDatabases = _a.sent();
                        if (!!createdDatabases.includes("wallets")) return [3 /*break*/, 3];
